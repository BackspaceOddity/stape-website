...
export const comparisonContent = {
  headline: 'Three options. Two waste your time.',
  subheadline: 'Choose wisely.',
  columns: {
    diy: 'Keep DIY-ing It',
  ...
  footer: {
    tagline: "We're not a better mousetrap. We're making mice irrelevant.",
    cta: {
      label: 'See what Option C looks like',
      href: '/demo',
    },
  },
};
