  ...
  return (
    <section className="py-20 md:py-28 bg-white">
      <div className="max-w-[700px] mx-auto px-6 md:px-12 text-center">
        ...
        >
          Most teams are paying their full roster within 2 cycles. Not because we pressured them, but because they stopped thinking about payroll.
        </motion.p>
      </div>
    </section>
  );
