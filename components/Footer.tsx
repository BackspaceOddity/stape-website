...
const productLinks = [
  { label: 'Contractor of Record', href: '/use-cases/contractor-of-record' },
  { label: 'Employer of Record', href: '/use-cases/employer-of-record' },
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        ...
        <div className="pt-8 border-t border-primary-foreground/20">
          <div className="text-xs text-primary-foreground/40 leading-relaxed space-y-1 mb-8">
            <div className="md:flex md:gap-12">
              ...
              <p>Stape Online LTD &middot; United Kingdom &middot; TW9 2NA</p>
            </div>
            <p className="mt-2">
        ...
        <div className="pt-6 border-t border-primary-foreground/20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" aria-label="X (Twitter)" className="text-primary-foreground/50 hover:text-primary-foreground transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
